        ...
        <div className="text-center space-y-8">
          ...
          <div className="max-w-4xl w-full mx-auto text-center text-5xl md:text-7xl font-semibold">
            <h1 className={"tracking-tighter"}>
              AI co-pilot for compliance clarity
          ...
          <p className="max-w-screen-sm mx-auto text-xl text-muted-foreground">
            {`Ask about regulations, get precise answers, and turn them into actionable compliance checklists in seconds.`}
          </p>
          ...
          <div className="space-y-4 md:space-y-0 md:space-x-4">
            ...
            >
              <Link
                href="https://github.com/NUS-FinTechLab/Reg-Guru"
                target="_blank"
              >
                Github Repository
