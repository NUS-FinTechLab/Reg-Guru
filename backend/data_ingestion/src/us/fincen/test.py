...
def main():
    ...
    query_texts="Is there any problem when a Chinese customer presents a Chinese passport and visa that have the same photos"

    results = query_with_date_range(test_collection, query_texts, datetime.datetime(2020, 1, 1), datetime.datetime(2024, 1, 1), n_results=5)
